...
public class HeatPicture_build {

    public void start(String heat_data){
    ...
    public static boolean writeImage(BufferedImage bi,int[] data){
        int i,j,r,g,b,min,max;
            ...
            String build_path ="D:\\heat2picture\\Inter_test\\x.png";
            try {
                ImageIO.write(bi, "png", new File(build_path));
               // Desktop.getDesktop().open(new File(ppath));
               HeatPicture_deal HPd = new HeatPicture_deal();
               HPd.start(bi);
            }catch (Exception e){
                e.printStackTrace();
            }
